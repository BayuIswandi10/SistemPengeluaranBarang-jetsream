...
class SuratDinasController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $suratDinas = SuratKendaraanDinas::create([
                ...
                'estimasi_waktu_kembali' => $request->estimasi_waktu_kembali,
    ...
    public function scanSecuritySuratDinas(Request $request)
    {
        $suratDinasId = $request->surat_kendaraan_dinas_id;
    ...
    public function edit(Request $request)
    {
        try {
            ...
            $kendaraanTersedia = KendaraanDinas::where('jenis_kendaraan', 1)
            ->whereNotExists(function ($query) use ($tanggalPenggunaan, $suratDinasId) {
        ...
        try {
            ...
            $data = $suratDinas->map(function ($surat) {
                ...
                return [
                    ...
                    'tujuan_penggunaan_3' => $surat->tujuan_penggunaan_3,
                    'jenis_kendaraan' => $surat->jenis_kendaraan,
                    'waktu_pergi' => $surat->waktu_pergi,
                    'estimasi_waktu_kembali' => $surat->estimasi_waktu_kembali,
                    'tanggal_penggunaan' => $surat->tanggal_penggunaan,
    ...
    public function pindahkanPeserta(Request $request)
    {
        ...
        foreach ($peserta as $nrp) {
            ...
            $pencatatanLamaList = PencatatanKendaraanDinas::where('nrp_karyawan', $nrp)
